...
def FullOTA_InstallEnd(info):
	...
	info.script.AppendExtra('ifelse(is_substring("SC-03D", getprop("ro.product.device")) || is_substring("SC-03D", getprop("ro.build.product")) || is_substring("celoxdcm", getprop("ro.product.device")) || is_substring("celoxdcm", getprop("ro.build.product")), run_program("/sbin/sh", "-c", "busybox echo SC-03D > /system/variant.prop"));')
